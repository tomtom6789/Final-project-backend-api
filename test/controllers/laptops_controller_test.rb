...
class LaptopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create laptop" do
    assert_difference('Laptop.count') do
      post laptops_url, params: { laptop: { condition: @laptop.condition, name: @laptop.name, price: @laptop.price } }, as: :json
    end
  ...
  test "should update laptop" do
    patch laptop_url(@laptop), params: { laptop: { condition: @laptop.condition, name: @laptop.name, price: @laptop.price } }, as: :json
    assert_response 200
  end
